...
// Admin-only: acts on ANY user by {user} id. 'role:super_admin|platform_admin'
// matches AuthPolicy::manageUsers()'s own rule (hasAnyRole([super_admin,
// platform_admin])) — kept consistent with how routes/auth/admin.php already
// gates admin routes, rather than introducing a separate authorization style.
