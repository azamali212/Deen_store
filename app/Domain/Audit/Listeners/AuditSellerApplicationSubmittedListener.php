...
final class AuditSellerApplicationSubmittedListener
{
    public function handle(SellerApplicationSubmitted $event): void
    {
        ...
        WriteAuditLogJob::dispatch(
            new CreateAuditLogDTO(
                action: AuditAction::SELLER_APPLICATION_SUBMITTED,
                ...
                description: 'Seller application submitted for review.',
                newValues: [
                    'application_id' => $event->application->id,
                    'store_name' => $event->application->store_name,
                    'business_type' => $event->application->business_type->value,
