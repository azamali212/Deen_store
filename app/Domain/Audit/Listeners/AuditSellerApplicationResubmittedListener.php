...
final class AuditSellerApplicationResubmittedListener
{
    public function handle(SellerApplicationResubmitted $event): void
    {
        ...
        WriteAuditLogJob::dispatch(
            new CreateAuditLogDTO(
                action: AuditAction::SELLER_APPLICATION_RESUBMITTED,
                ...
                description: 'Rejected seller application corrected and resubmitted.',
                newValues: [
