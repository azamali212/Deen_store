    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'App\Repositories\Email\EmailRepositoryInterface' => \App\Repositories\Email\EmailRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/azam_ali/Deen_store/apiV1/public/storage' => 'string',
            ...
            'roles.Super Admin.permissions' => 'string',
            'roles.Super Admin.guard_name' => 'string',
            'roles.Admin.permissions' => 'string',
            'roles.Admin.guard_name' => 'string',
            'roles.Vendor Admin.permissions' => 'string',
            'roles.Vendor Admin.guard_name' => 'string',
            'roles.Customer.permissions' => 'string',
            'roles.Customer.guard_name' => 'string',
            'roles.Delivery Manager.permissions' => 'string',
            'roles.Store Admin.permissions' => 'string',
            'roles.Store Admin.inherits' => 'string',
            'roles.Store Admin.guard_name' => 'string',
            'roles.Product Admin.permissions' => 'string',
            'roles.Product Admin.guard_name' => 'string',
            'roles.Order Admin.permissions' => 'string',
            'roles.Order Admin.guard_name' => 'string',
...
'filesystems.links./Users/azam_ali/Deen_store/apiV1/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'queue.failed.table','roles.Super Admin.permissions','roles.Super Admin.guard_name','roles.Admin.permissions','roles.Admin.guard_name',
'roles.Vendor Admin.permissions','roles.Vendor Admin.guard_name','roles.Customer.permissions','roles.Customer.guard_name','roles.Delivery Manager.permissions',
'roles.Store Admin.permissions','roles.Store Admin.inherits','roles.Store Admin.guard_name','roles.Product Admin.permissions','roles.Product Admin.guard_name',
'roles.Order Admin.permissions','roles.Order Admin.guard_name','sanctum.stateful','sanctum.guard','sanctum.expiration',
...
'sanctum.csrf-cookie','verification.verify','storage.local',);
...
'QUEUE_CONNECTION','AI_API_KEY','AI_API_URL','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
